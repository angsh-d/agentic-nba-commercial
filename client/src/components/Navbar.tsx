    ...
    <nav className="sticky top-0 z-50 w-full bg-white/70 backdrop-blur-xl border-b border-black/5 shadow-sm h-[52px] flex items-center justify-between px-6 transition-all duration-300 support-[backdrop-filter]:bg-white/50">
      ...
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-3">
          <Avatar className="h-9 w-9 rounded-full bg-gray-100 flex items-center justify-center border border-black/5 shadow-sm">
            <AvatarFallback className="bg-gradient-to-br from-gray-100 to-gray-200 text-gray-900 font-bold text-[10px] tracking-wider">SAAMA</AvatarFallback>
          </Avatar>
          <div className="h-6 w-[1px] bg-gray-200 mx-1" />
          <div className="flex items-baseline gap-2">
            <span className="text-[17px] font-semibold tracking-tight text-gray-900 font-display">Saama</span>
            <span className="text-[17px] font-normal text-gray-500 tracking-tight">Digital Study Platform</span>
          </div>
        </div>
      </div>
